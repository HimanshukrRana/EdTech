...
export default async function (req, res) {
  ...
  const mailData = {
    ...
    from: `${req.body.email}`,
    subject: `Enquiry for Finsweet by ${req.body.name} `,
...
<![endif]-->
    <meta httptoEquiv="Content-Type" content="text/html; charSet=UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="x-apple-disable-message-reformatting">
    <!--[if !mso]><!-->
    <meta httptoEquiv="X-UA-Compatible" content="IE=edge"><!--<![endif]-->
    <title></title>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://ik.imagekit.io/fabmenopause/bizlyft-logo.jpg?updatedAt=1687257838150" alt="Logo"
                                                                            title="Logo"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;"
                                                        ...
                                                        <div
                                                            style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                            <p style="font-size: 14px; line-height: 140%; ">Phone Number :
                                                                ${req.body.phone}
                                                            </p>
                                                        </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;"
                                                            ...
                                                            <div
                                                                style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%; ">Subject :
                                                                    ${req.body.subject}
                                                                </p>
                                                            </div>
